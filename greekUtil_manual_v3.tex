...
\begin{document}
	...
	\verb|\onequote[|\emph{options}\verb|]{|\emph{text}\verb|}{|\emph{apparatus}\verb|}|\marginpar{\texttt{\textbackslash onequote}}
	...
	\verb|\twoquote[|\emph{options}\verb|]{|\emph{column1}\verb|}{|\emph{column2}\verb|}{|\emph{apparatus}\verb|}| \marginpar{\texttt{\textbackslash twoquote}}
	...
	Finally, a macro \verb|\apparatus{|\emph{text}\verb|}|\marginpar{\texttt{\textbackslash apparatus}} is defined for a single isolated instance of a critical apparatus. Its use is not recommended unless strictly necessary.
